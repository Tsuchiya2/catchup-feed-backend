...
//     検知する。
//
// **format.go に文言を足したら、ここに1行足すこと。** サニタイズの見張り
// (sanitize_test.go の TestFixedPhrasesSurviveSanitizing — 承認済みの文案が
// 読み上げ前のサニタイズで書き換わらないことを確かめる)も、この表を入口に
// している。表に足し忘れた文言はどのテストにも守られない。 逆に、走査が偽陽性を
